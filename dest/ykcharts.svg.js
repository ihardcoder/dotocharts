...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dial = __webpack_require__(1);

	var _dial2 = _interopRequireDefault(_dial);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.Dial = _dial2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _js = __webpack_require__(160);
	...
	var Dial = function () {
	  ...
	  _createClass(Dial, [{
	    key: 'init',
	    value: function init() {
	      var _size = this.conf.size || parseInt(d3.select(this.container).style('width'));
	      ...
	      this.DOM = (0, _reactDom.render)(_react2.default.createElement(_js.DialDOM, { size: _size, fontSize: _fontSize, fontFamily: _fontFamily, dataset: this.dataset }), this.container);
	    }
	    /**
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.DialDOM = undefined;

	var _DialDOM2 = __webpack_require__(161);

	var _DialDOM3 = _interopRequireDefault(_DialDOM2);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.DialDOM = _DialDOM3.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ykd = __webpack_require__(162);

	var _ykd2 = _interopRequireDefault(_ykd);

	var _DialBox = __webpack_require__(163);

	var _DialBox2 = _interopRequireDefault(_DialBox);

	var _DialArc = __webpack_require__(164);

	var _DialArc2 = _interopRequireDefault(_DialArc);

	var _DialMidText = __webpack_require__(166);

	var _DialMidText2 = _interopRequireDefault(_DialMidText);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	// 整体组件入口
	var DialDOM = _react2.default.createClass({
	  displayName: 'DialDOM',

	  propTypes: {
	    size: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.number]).isRequired,
	  ...
	  render: function render() {
	    var _data = this.props.dataset.children;
	    var _Arcs = [];
	    var _total = _data.length;
	    var _average = 2 / _total * Math.PI;
	    // 最大间距不超过5度
	    var _maxGap = 5 * Math.PI / 180;
	    // 实体弧线的跨度
	    var _step = _average * 0.1 > _maxGap ? _average - _maxGap : _average * 0.9;
	    // 旋转负角度
	    var _rotate = _step / 2;
	    // 刻度个数
	    var _ticksum = 20;
	    //刻度弧度
	    var _tickstep = _step / _ticksum;
	    // 标签的字号
	    var _nameFontSize = this.state.fontSize;
	    // 中间文字的主标题字号
	    var _midMainFontSize = this.state.fontSize * 3;
	    // 中间文字的副标题字号
	    var _midSubFontSize = this.state.fontSize;
	    // 中间文字垂直偏移
	    var _mainDy = this.state.fontSize / 10;
	    // 中间文字副标题字号
	    var _subDy = this.state.fontSize * 1.5;
	    if (_data) {
	      for (var i = 0; i < _total; i++) {
	        var _startAngle = _average * i - _rotate;
	        var _endAngle = _startAngle + _step;
	        _Arcs.push(_react2.default.createElement(_DialArc2.default, { radius: this.state.size / 2,
	          dataset: _data[i],
	          key: i,
	          range: i,
	    ...
	    var _transform = _ykd2.default.transform('translate(' + this.state.size / 2 + ',' + this.state.size / 2 + ')');
	    return _react2.default.createElement(
	      _DialBox2.default,
	      { size: this.state.size, fontSize: this.props.fontSize, fontFamily: this.props.fontFamily },
	      _Arcs,
	      _react2.default.createElement(_DialMidText2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 容器dom
	var DialBox = _react2.default.createClass({
	  displayName: 'DialBox',
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      'svg',
	      { width: this.props.size, height: this.props.size, style: {
	          fontSize: this.props.fontSize,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DialTick = __webpack_require__(165);

	var _DialTick2 = _interopRequireDefault(_DialTick);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	// 表盘外围圆弧
	var DialArc = _react2.default.createClass({
	  displayName: 'DialArc',

	  propTypes: {
	    radius: _react.PropTypes.number.isRequired,
	    startAngle: _react.PropTypes.number.isRequired,
	    endAngle: _react.PropTypes.number.isRequired,
	    padding: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.number]).isRequired,
	    border: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.number]).isRequired,
	    ticksum: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.number]).isRequired,
	    tickstep: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.number]).isRequired,
	    range: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.number]).isRequired,
	    fontSize: _react.PropTypes.number.isRequired,
	  ...
	  componentDidMount: function componentDidMount() {
	    var _arcAniTime = 600,
	        ...
	        _tickAniTime = 50;
	    // path动画
	    var _endAngle = this.props.endAngle;
	    var _arc = _ykd2.default.svg.arc().innerRadius(this.props.radius - this.props.padding - this.props.border).outerRadius(this.props.radius - this.props.padding).startAngle(this.props.startAngle);
	    var path = _ykd2.default.select(this.refs.path);
	    path.datum({ endAngle: this.props.startAngle });
	    path.transition().duration(_arcAniTime).attrTween('d', function (d) {
	      var interpolate = _ykd2.default.interpolate(d.endAngle, _endAngle);
	      return function (t) {
	    ...
	    //text动画
	    var text = _ykd2.default.select(this.refs.text);
	    text.transition().delay(_arcAniTime).duration(_textAniTime).style('opacity', '1');
	    // ticks动画
	    var _textShowtime = _arcAniTime / this.props.ticksum;
	    for (var i = 0; i < this.props.ticksum; i++) {
	      _ykd2.default.select((0, _reactDom.findDOMNode)(this.refs['tick_' + i])).transition().delay(_textShowtime * i).duration(_textShowtime * 2 / 3).style('opacity', 0.4);
	    }
	    var score_ticks_num = Math.floor(this.props.dataset.score * this.props.ticksum / 100);
	    for (var i = 0; i < score_ticks_num; i++) {
	      _ykd2.default.select((0, _reactDom.findDOMNode)(this.refs['tick_' + i])).transition().delay(_arcAniTime + _tickAniTime * i).duration(_tickAniTime).style('opacity', 1);
	    }
	  },
	  render: function render() {
	    var _arc = _ykd2.default.svg.arc().innerRadius(this.props.radius - this.props.padding - this.props.border).outerRadius(this.props.radius - this.props.padding).startAngle(this.props.startAngle).endAngle(this.props.endAngle);
	    var _transform = _ykd2.default.transform('translate(' + this.props.radius + ',' + this.props.radius + ')');
	    var ticks = [];
	    for (var i = 0; i < this.props.ticksum; i++) {
	      var _ref = 'tick_' + i;
	      ticks.push(_react2.default.createElement(_DialTick2.default, { startAngle: this.props.startAngle + this.props.tickstep * i,
	    ...
	    return _react2.default.createElement(
	      'g',
	      { transform: _transform },
	      _react2.default.createElement('path', { ref: 'path',
	        id: this.state.arcID,
	        d: _arc(),
	        fill: this.props.dataset.color }),
	      _react2.default.createElement(
	        'text',
	        { ref: 'text', dx: '50%', dy: '-10px', textAnchor: 'end', style: {
	            opacity: 0,
	            fontSize: this.props.fontSize
	          },
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 时刻小圆弧
	var DialTick = _react2.default.createClass({
	  displayName: 'DialTick',
	  ...
	  render: function render() {
	    var _arc = _ykd2.default.svg.arc().innerRadius(this.props.radius - 15).outerRadius(this.props.radius - 5).startAngle(this.props.startAngle).endAngle(this.props.endAngle);
	    return _react2.default.createElement(
	      'g',
	      { style: { opacity: 0 } },
	      _react2.default.createElement('path', { ref: 'tickpath',
	        d: _arc(),
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 中心文字
	var DialMidText = _react2.default.createClass({
		displayName: 'DialMidText',

		propTypes: {
			transform: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.object]).isRequired,
			finalscore: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.number]).isRequired,
			mainFontSize: _react.PropTypes.number.isRequired,
			subFontSize: _react.PropTypes.number.isRequired,
			fontColor: _react.PropTypes.string.isRequired,
			mainDy: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.number]).isRequired,
			subDy: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.number]).isRequired
		},
		render: function render() {
			var _rankText = '超越了全国' + this.props.rank + '的团队';
			var _rankTextTransform = _ykd2.default.transform('scale(0.1)');
			return _react2.default.createElement(
				'g',
				...
				_react2.default.createElement(
					...
					{ style: {
						...
						}, textAnchor: 'middle', y: this.props.mainDy, fill: this.props.fontColor },
				...
				_react2.default.createElement(
					...
					{ style: {
						...
						}, textAnchor: 'middle', y: this.props.subDy, fill: this.props.fontColor },
					_rankText
				)
			);
		}
